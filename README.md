# Decorated L Theory Assembly — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/decorated-l-theory-assembly-canonical-lane-mathlib.git
cd decorated-l-theory-assembly-canonical-lane-mathlib
lake exe
lake build
```
