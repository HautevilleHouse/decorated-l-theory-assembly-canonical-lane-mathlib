...
This module internalizes the theorem-facing object for `decorated-l-theory-assembly-canonical-lane`
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "manifold-constrained theorem certificate for Decorated L-Theory Assembly internalized through baseline gates, source constants, reviewer bridge, manifest hashes, outside-constant dependency count, and Mathlib-native closure layer",
